...
**Canonical Arweave wallet:** gr_QxtMLNpWgWZFuXfnxF7rmHDRk1IjRFcvp9o8FJaA
...
entry's fingerprint is also recorded on Bitcoin via OpenTimestamps. This page is saved
to the Wayback Machine and archive.today whenever it changes, so anyone can confirm the
record is complete and was never altered after the fact.
